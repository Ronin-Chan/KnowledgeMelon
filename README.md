...
- Custom model management with user-defined model IDs, display names, providers, base URLs, context windows, and pinned ordering
...
- **自定义模型管理**  
  支持新增、编辑、删除自己的模型定义，可以配置模型 ID、显示名称、provider、base URL、上下文长度，并支持置顶排序，适合接入私有模型或代理服务。
